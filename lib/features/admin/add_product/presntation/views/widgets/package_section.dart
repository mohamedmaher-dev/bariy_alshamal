...
class PackageSection extends StatelessWidget {
  const PackageSection({super.key, required this.controller});
      ...
      children: [
          ...
          onAdd: () {
            showDialog(
              ...
              builder: (contextDialog) => AddExtraDialog(
                ...
                onPressed: () {
                  controller.add(AddExtraPackage());
                },
              ),
            );
          },
        ...
        ListView.builder(
          ...
          itemBuilder: (context, index) => ExtraItem(
            details: controller.packagesList[index].details,
            extraPrice: controller.packagesList[index].price.toString(),
            onDelete: () {
              controller.add(DeleteExtraPackage(index: index));
            },
          ),
        )
      ],
