...
class CuttingSection extends StatelessWidget {
  const CuttingSection({super.key, required this.controller});
    ...
    return ListView(
      ...
      children: [
          ...
          onAdd: () {
            showDialog(
              ...
              builder: (contextDialog) => AddExtraDialog(
                ...
                onPressed: () {
                  controller.add(AddExtraCutting());
                },
              ),
            );
          },
        ...
        ListView.builder(
          shrinkWrap: true,
          physics: const NeverScrollableScrollPhysics(),
          itemCount: controller.cuttingList.length,
          itemBuilder: (context, index) => ExtraItem(
            details: controller.cuttingList[index].details,
            extraPrice: controller.cuttingList[index].price.toString(),
            onDelete: () {
              controller.add(DeleteExtraCutting(index: index));
            },
          ),
        )
      ],
